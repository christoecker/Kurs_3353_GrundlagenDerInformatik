...
KI-Werkzeuge (ChatGPT, Claude, GitHub Copilot und Ähnliches) gehören
inzwischen zum Berufsalltag in der Softwareentwicklung. Deshalb sind sie
fester Bestandteil dieses Kurses — aber nicht von Anfang an und nicht in
jeder Aufgabe gleich.

## Der Grundgedanke

Ihr sollt **im Lead bleiben**. KI ist ein Werkzeug, das ihr steuert und
dessen Ergebnis ihr beurteilt — kein Ersatz dafür, eine Sache selbst
verstanden zu haben.

Das hat einen ganz praktischen Grund: Eine KI liefert fast immer *etwas*.
Ob dieses Etwas korrekt, effizient und wartbar ist, könnt ihr nur beurteilen,
...
**Beschreibt das Problem, nicht die Lösung.** Wer eine KI bittet, "eine
Funktion zu schreiben, die ein Array sortiert", bekommt Code. Wer sie
bittet, "zu erklären, warum dieser Bubble-Sort beim letzten Element
abbricht", bekommt Verständnis.
...
C++. KI-Werkzeuge rutschen hier gerne ab und liefern C++-Code, der zwar
kompiliert, aber nicht das ist, was wir hier lernen. Prüft das aktiv.
